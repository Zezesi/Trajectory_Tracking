...
### 1️⃣ NMPC_TrajTracking_CasADi.py: pure trajectory tracking. 
...
### 2️⃣ NMPC_TrajTrackingAndObstacleAvoidance_CasADi.py: trajectory tracking and obstacle avoidance with hard constraints. 
...
### 3️⃣ NMPC_TrajTrackingAndSoftObstacleAvoidance_CasADi.py: trajectory tracking and obstacle avoidance with soft constraints. 
...
### 4️⃣ NMPC_TrajTracking_CasADi1.py: pure trajectory tracking, in the above scripts, delta actions are used to ensure smooth action transition, now jerk and delta_f_dot are modelled in the nmpc model.
...
### 5️⃣ LQR_TrajTracking.py: pure trajectory tracking based on a linearized vehicle kinematic model.
